"""
Add project collaboration to existing Refinify app
Run this after installing flask-jwt-extended
"""

# Add these lines to your app.py file after the existing imports:
...
try:
    ...
    print(f"Project collaboration not available: {e}")
...
print("\nProject collaboration system is ready!")
print("\nKey features:")
print("- Operation-based collaboration")
print("- Automatic dataset versioning") 
